...
q6_levels <- if (exists("q6_levels", inherits = FALSE)) {
  q6_levels
} else {
...
q6_tables_for_research <- list(
  "01_q6_level_overview" = q6_level_overview,
  "02_q6_group_1_distribution" = q6_group_1_distribution,
  "03_q6_group_2_distribution" = q6_group_2_distribution,
  "04_q6_block_distribution" = q6_block_distribution,
  "05_q6_q52_distribution" = q6_q52_distribution
)

writexl::write_xlsx(
  q6_tables_for_research,
  path = file.path(out_base_dir, "10_q6_duration_effect_tables.xlsx")
)

gt_manifest_10 <- save_table_collection_as_gt(
  table_list = q6_tables_for_research,
  out_gt_html_dir = out_gt_html_dir,
  out_gt_rtf_dir = out_gt_rtf_dir,
  out_gt_doc_dir = out_gt_doc_dir,
  manifest_base_filename = "10_q6_duration_effect_gt_manifest",
  index_title = "Q6 duration effect tables - GT outputs",
  index_intro = "This index links to publication-oriented HTML and RTF versions of all Q6 duration effect tables.",
